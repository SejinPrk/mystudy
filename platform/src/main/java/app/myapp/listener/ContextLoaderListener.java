...
import app.myapp.dao.mysql.SubscriptionDaoImpl;
...
public class ContextLoaderListener implements ServletContextListener {
  ...
  public void contextInitialized(ServletContextEvent sce) {
    ...
    SubscriptionDao subscriptionDao = new SubscriptionDaoImpl(connectionPool);
    ...
    웹애플리케이션저장소.setAttribute("subscriptionDao", subscriptionDao);
