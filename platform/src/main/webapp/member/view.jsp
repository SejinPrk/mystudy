...
<div>
    전화번호: <input name='tel' type='tel' value='${member.tel}'>
</div>
<div>
    가입일: <input readonly type='text' value='${member.createdDate}'>
</div>
<div>
    카드번호: <input name='credit_no' type='int' value='${member.creditNo}'>
</div>
<div>
    유효기간: <input name='credit_date' type='text' value='${member.creditDate}'>
</div>
<div>
    알림설정: <input name='notification' type='tinyint' value='${member.notification}'>
</div>
<div>
  <button>변경</button>
