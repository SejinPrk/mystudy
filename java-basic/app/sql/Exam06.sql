...
insert into lect(lno, titl, sdt, edt, qnty, pric, nat_sup, sup_typ, dsct)
values(4, '인공지능', '2024-5-1', '2024-10-30', 30, 300, 'Y', 'K디지털', 'ok');
insert into lect(lno, titl, sdt, edt, qnty, pric, nat_sup, sup_typ, dsct)
values(5, '데브옵스', '2024-4-1', '2024-12-30', 30, 300, 'Y', 'K디지털', 'ok');
insert into lect(lno, titl, sdt, edt, qnty, pric, nat_sup, sup_typ, dsct)
values(6, '클라우드', '2024-6-1', '2024-11-30', 30, 300, 'Y', 'K디지털', 'ok');
