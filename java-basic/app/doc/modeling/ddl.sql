...
ALTER TABLE lms_application
  ADD CONSTRAINT PK_lms_application -- 수강신청 Primary key
  PRIMARY KEY (
...
ALTER TABLE lms_lectures
  ADD CONSTRAINT PK_lms_lectures -- 과정 Primary key
  PRIMARY KEY (
  lecture_no -- 과정번호
  );
...
ALTER TABLE lms_managers
  ADD CONSTRAINT PK_lms_managers -- 매니저 Primary key
  PRIMARY KEY (
  manager_no -- 매니저번호
  );
...
ALTER TABLE lms_rooms
  ADD CONSTRAINT PK_lms_rooms -- 강의실 Primary key
  PRIMARY KEY (
  room_no -- 강의실번호
  );
...
ALTER TABLE lms_photos
  ADD CONSTRAINT PK_lms_photos -- 강의실사진 Primary key
  PRIMARY KEY (
  photo_no -- 강의실사진번호
  );
...
ALTER TABLE lms_centers
  ADD CONSTRAINT PK_lms_centers -- 교육센터 Primary key
  PRIMARY KEY (
  center_no -- 교육센터번호
  );
...
ALTER TABLE lms_address
  ADD CONSTRAINT PK_lms_address -- 주소 Primary key
  PRIMARY KEY (
  address_no -- 주소번호
  );
...
CREATE TABLE lms_students (
  student_no  INTEGER      NOT NULL COMMENT '학생번호', -- 학생번호
  jumin       VARCHAR(255) NULL     COMMENT '주민번호', -- 주민번호
...
ALTER TABLE lms_students
  ADD CONSTRAINT PK_lms_students -- 학생 Primary key
  PRIMARY KEY (
  student_no -- 학생번호
  );
...
ALTER TABLE lms_level
  ADD CONSTRAINT PK_lms_level -- 학력 Primary key
  PRIMARY KEY (
  level_no -- 학력번호
  );
...
ALTER TABLE lms_teacher_lecture
  ADD CONSTRAINT PK_lms_teacher_lecture -- 강의배정 Primary key
  PRIMARY KEY (
  lecture_no, -- 과정번호
  teacher_no  -- 강사번호
  );
...
ALTER TABLE lms_departments
  ADD CONSTRAINT PK_lms_departments -- 부서 Primary key
  PRIMARY KEY (
  department_no -- 부서번호
  );
...
ALTER TABLE lms_members
  ADD CONSTRAINT PK_lms_members -- 회원 Primary key
  PRIMARY KEY (
  member_no -- 회원번호
  );
