...
public class Exam0210 {
  public static void main(String[] args) throws Exception {
    ...
    char c = s1.charAt(1); //전형적인 인스턴스 메서드
    System.out.println(c);

    System.out.println(s1.compareTo("Helli")); // compareTo도 전형적인 인스턴스 메서드
    System.out.println(s1.compareTo("Hello"));
    System.out.println(s1.compareTo("Hellq"));

    System.out.println(s1.contains("ll")); // contains도 전형적인 인스턴스 메서드
