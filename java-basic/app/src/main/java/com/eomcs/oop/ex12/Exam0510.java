...
public class Exam0510 {
  ...
  public static void main(String[] args) {
    ...
    Calculator c3 = MyCalculator::multiple; // => Calculator c3 = (x, y) -> MyCalculator.multuple(x, y);
    Calculator c4 = MyCalculator::divide; // => Calculator c4 = (x, y) -> MyCalculat0r.divide(x, y);
